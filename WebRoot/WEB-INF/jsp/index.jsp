			...
			<div id="hotProduct" class="hotProduct clearfix">
				<div class="title">
					...
					<ul class="tabContent" style="display: block;">
						<s:iterator value="hProductList" var="hProduct">
							<li>
								<a href="${pageContext.request.contextPath}/product_findByPid.action?pid=<s:property value="#hProduct.pid"/>"
								 	target="_blank"><img src="${pageContext.request.contextPath}/<s:property value="#hProduct.image"/>"
								 	 data-original="http://storage.shopxx.net/demo-image/3.0/201301/0ff130db-0a1b-4b8d-a918-ed9016317009-thumbnail.jpg" style="display: block;"></a>
							</li>
						</s:iterator>		
					</ul>
		...
		<div class="span24">
			<div id="newProduct" class="newProduct clearfix">
					...
					<ul class="tab">
						 ...
						 <ul class="tabContent" style="display: block;">
						 <s:iterator value="nProductList" var="nProduct">
							<li>
								<a href="${pageContext.request.contextPath}/product_findByPid.action?pid=<s:property value="#nProduct.pid"/>" 
									target="_blank"><img src="${pageContext.request.contextPath}/<s:property value="#nProduct.image" />" 
									data-original="http://storage.shopxx.net/demo-image/3.0/201301/4a51167a-89d5-4710-aca2-7c76edc355b8-thumbnail.jpg" style="display: block;"></a>									
							</li>
						</s:iterator>
						</ul>
						<ul class="tabContent" style="display: none;">
